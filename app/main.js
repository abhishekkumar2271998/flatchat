...
// Minimal .env loader (no dependency). Loads KEY=VALUE pairs into process.env
// without overwriting variables already set in the environment. Looks in the
// app directory and the repo root so it works in dev from either location.
(function loadDotEnv() {
  const candidates = [
